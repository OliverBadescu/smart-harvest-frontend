  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-violet-900 mb-4">Our Products</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Explore our range of innovative agricultural sensors designed to help you monitor, 
          analyze, and optimize your farming practices.
        </p>
      </div>
